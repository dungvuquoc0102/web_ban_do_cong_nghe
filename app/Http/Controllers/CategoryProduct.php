...
class CategoryProduct extends Controller
{
    ...
    public function all_category_product()
    {
        ...
        // $manager_category_product  = view('admin.category.all_category_product')->with(compact('all_category_product', 'category_product'));

        // return view('admin_layout')->with('admin.category.all_category_product', $manager_category_product);
        return view('admin.category.all_category_product')->with(compact('all_category_product', 'category_product'));
    }
    ...
    public function edit_category_product($category_product_id)
    {
        ...
        return view('admin.category.edit_category_product')->with(compact('category', 'edit_category_product'));
    }
